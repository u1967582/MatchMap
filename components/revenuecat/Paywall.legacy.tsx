...
export default function Paywall({
  ...
  const loadOffering = async () => {
    try {
      ...
      console.log(
        '[Paywall] getOfferings resposta:',
        currentOffering ? `${currentOffering.availablePackages.length} paquets` : 'null'
      );
  ...
  const handleRestore = async () => {
    try {
      ...
      toast.error(
        ...
        'Asegúrate de haber realizado compras previamente'
      );
    } finally {
      setPurchasing(false);
    }
          ...
          {loading ? (
            ...
            <ScrollView
                ...
                <TouchableOpacity
                  ...
                  <View style={styles.packageHeader}>
                    <View style={styles.packageInfo}>
                      <AppText style={styles.packageTitle}>{getPackageTitle(pkg)}</AppText>
              ...
              <AppText style={styles.footerText}>
                La compra se cargará a tu cuenta de Apple/Google. Puedes cancelar en cualquier
                momento.
              </AppText>
            </ScrollView>
          )}
